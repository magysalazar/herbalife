...
/**
 * Base class that represents a row from the 'hbf_porciones' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class HbfPorciones implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\HbfPorcionesTableMap';
    ...
    /**
     * Initializes internal state of Base\HbfPorciones object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>HbfPorciones</code> instance.  If
     * <code>obj</code> is an instance of <code>HbfPorciones</code>, delegates to
     * <code>equals(HbfPorciones)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|HbfPorciones The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_porcion] column value.
     *
     * @return int
     */
    public function getIdPorcion()
    {
        return $this->id_porcion;
    }
    ...
    /**
     * Set the value of [id_porcion] column.
     *
     * @param int $v new value
     * @return $this|\HbfPorciones The current object (for fluent API support)
     */
    public function setIdPorcion($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_porcion !== $v) {
            $this->id_porcion = $v;
            $this->modifiedColumns[HbfPorcionesTableMap::COL_ID_PORCION] = true;
        }
    ...
    public function setIdProducto($v)
    {
        ...
        if ($this->id_producto !== $v) {
            $this->id_producto = $v;
            $this->modifiedColumns[HbfPorcionesTableMap::COL_ID_PRODUCTO] = true;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[HbfPorcionesTableMap::COL_CANTIDAD] = true;
        }
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[HbfPorcionesTableMap::COL_ESTADO] = true;
        }
    ...
    public function setChangeCount($v)
    {
        ...
        if ($this->change_count !== $v) {
            $this->change_count = $v;
            $this->modifiedColumns[HbfPorcionesTableMap::COL_CHANGE_COUNT] = true;
        }
    ...
    public function setIdUserModified($v)
    {
        ...
        if ($this->id_user_modified !== $v) {
            ...
            $this->modifiedColumns[HbfPorcionesTableMap::COL_ID_USER_MODIFIED] = true;
        }
    ...
    public function setIdUserCreated($v)
    {
        ...
        if ($this->id_user_created !== $v) {
            ...
            $this->modifiedColumns[HbfPorcionesTableMap::COL_ID_USER_CREATED] = true;
        }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HbfPorcionesTableMap::COL_DATE_MODIFIED] = true;
            }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HbfPorcionesTableMap::COL_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HbfPorcionesTableMap::translateFieldName('IdPorcion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_porcion = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HbfPorcionesTableMap::translateFieldName('IdProducto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_producto = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HbfPorcionesTableMap::translateFieldName('Cantidad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cantidad = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HbfPorcionesTableMap::translateFieldName('Estado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estado = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HbfPorcionesTableMap::translateFieldName('ChangeCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : HbfPorcionesTableMap::translateFieldName('IdUserModified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_modified = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : HbfPorcionesTableMap::translateFieldName('IdUserCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : HbfPorcionesTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_modified = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : HbfPorcionesTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = HbfPorcionesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\HbfPorciones'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHbfPorcionesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see HbfPorciones::setDeleted()
     * @see HbfPorciones::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHbfPorcionesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HbfPorcionesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_PORCION)) {
            $modifiedColumns[':p' . $index++]  = 'id_porcion';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_PRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = 'id_producto';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_CANTIDAD)) {
            $modifiedColumns[':p' . $index++]  = 'cantidad';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'estado';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_CHANGE_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'change_count';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_USER_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_modified';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_USER_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_created';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_DATE_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'date_modified';
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }

        $sql = sprintf(
            'INSERT INTO hbf_porciones (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_porcion':
                        $stmt->bindValue($identifier, $this->id_porcion, PDO::PARAM_INT);
                        break;
                    case 'id_producto':
    ...
    {
        $pos = HbfPorcionesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['HbfPorciones'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['HbfPorciones'][$this->hashCode()] = true;
        $keys = HbfPorcionesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdPorcion(),
            $keys[1] => $this->getIdProducto(),
            $keys[2] => $this->getCantidad(),
            $keys[3] => $this->getEstado(),
            $keys[4] => $this->getChangeCount(),
            $keys[5] => $this->getIdUserModified(),
            $keys[6] => $this->getIdUserCreated(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdPorcion($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdProducto($arr[$keys[1]]);
        }
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setChangeCount($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setIdUserModified($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setIdUserCreated($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setDateModified($arr[$keys[7]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_PORCION)) {
            $criteria->add(HbfPorcionesTableMap::COL_ID_PORCION, $this->id_porcion);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_PRODUCTO)) {
            $criteria->add(HbfPorcionesTableMap::COL_ID_PRODUCTO, $this->id_producto);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_CANTIDAD)) {
            $criteria->add(HbfPorcionesTableMap::COL_CANTIDAD, $this->cantidad);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ESTADO)) {
            $criteria->add(HbfPorcionesTableMap::COL_ESTADO, $this->estado);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_CHANGE_COUNT)) {
            $criteria->add(HbfPorcionesTableMap::COL_CHANGE_COUNT, $this->change_count);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_USER_MODIFIED)) {
            $criteria->add(HbfPorcionesTableMap::COL_ID_USER_MODIFIED, $this->id_user_modified);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_ID_USER_CREATED)) {
            $criteria->add(HbfPorcionesTableMap::COL_ID_USER_CREATED, $this->id_user_created);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(HbfPorcionesTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(HbfPorcionesTableMap::COL_DATE_CREATED)) {
            $criteria->add(HbfPorcionesTableMap::COL_DATE_CREATED, $this->date_created);
        }
    ...
    {
        $criteria = ChildHbfPorcionesQuery::create();
        $criteria->add(HbfPorcionesTableMap::COL_ID_PORCION, $this->id_porcion);
    ...
    {
        $validPk = null !== $this->getIdPorcion();
    ...
    /**
     * Generic method to set the primary key (id_porcion column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \HbfPorciones (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdPorcion(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \HbfPorciones Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCiUsuariosRelatedByIdUserCreated(ChildCiUsuarios $v = null)
    {
        ...
        if ($v !== null) {
            $v->addHbfPorcionesRelatedByIdUserCreated($this);
        }
    ...
    public function getCiUsuariosRelatedByIdUserCreated(ConnectionInterface $con = null)
    {
        if ($this->aCiUsuariosRelatedByIdUserCreated === null && ($this->id_user_created != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCiUsuariosRelatedByIdUserCreated->addHbfPorcionessRelatedByIdUserCreated($this);
             */
        }
    ...
    public function setCiUsuariosRelatedByIdUserModified(ChildCiUsuarios $v = null)
    {
        ...
        // If this object has already been added to the ChildCiUsuarios object, it will not be re-added.
        if ($v !== null) {
            $v->addHbfPorcionesRelatedByIdUserModified($this);
        }
    ...
    public function getCiUsuariosRelatedByIdUserModified(ConnectionInterface $con = null)
    {
        if ($this->aCiUsuariosRelatedByIdUserModified === null && ($this->id_user_modified != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCiUsuariosRelatedByIdUserModified->addHbfPorcionessRelatedByIdUserModified($this);
             */
        }
    ...
    public function getHbfProductos(ConnectionInterface $con = null)
    {
        if ($this->aHbfProductos === null && ($this->id_producto != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aHbfProductos->addHbfPorcioness($this);
             */
        }
    ...
    {
        if (null !== $this->aCiUsuariosRelatedByIdUserCreated) {
            $this->aCiUsuariosRelatedByIdUserCreated->removeHbfPorcionesRelatedByIdUserCreated($this);
        }
        if (null !== $this->aCiUsuariosRelatedByIdUserModified) {
            $this->aCiUsuariosRelatedByIdUserModified->removeHbfPorcionesRelatedByIdUserModified($this);
        }
        if (null !== $this->aHbfProductos) {
            $this->aHbfProductos->removeHbfPorciones($this);
        }
        $this->id_porcion = null;
    ...
    {
        return (string) $this->exportTo(HbfPorcionesTableMap::DEFAULT_STRING_FORMAT);
    }
