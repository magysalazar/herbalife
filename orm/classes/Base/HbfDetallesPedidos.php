...
/**
 * Base class that represents a row from the 'hbf_detalles_pedidos' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class HbfDetallesPedidos implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\HbfDetallesPedidosTableMap';
    ...
    /**
     * Initializes internal state of Base\HbfDetallesPedidos object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>HbfDetallesPedidos</code> instance.  If
     * <code>obj</code> is an instance of <code>HbfDetallesPedidos</code>, delegates to
     * <code>equals(HbfDetallesPedidos)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|HbfDetallesPedidos The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_detalle_pedido] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_detalle_pedido] column.
     *
     * @param int $v new value
     * @return $this|\HbfDetallesPedidos The current object (for fluent API support)
     */
    public function setIdDetallePedido($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_detalle_pedido !== $v) {
            $this->id_detalle_pedido = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO] = true;
        }
    ...
    public function setIdComanda($v)
    {
        ...
        if ($this->id_comanda !== $v) {
            $this->id_comanda = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_COMANDA] = true;
        }
    ...
    public function setIdVaso($v)
    {
        ...
        if ($this->id_vaso !== $v) {
            $this->id_vaso = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_VASO] = true;
        }

        if ($this->aHbfVasos !== null && $this->aHbfVasos->getIdVaso() !== $v) {
            $this->aHbfVasos = null;
        }
    ...
    public function setIdProducto($v)
    {
        ...
        if ($this->id_producto !== $v) {
            $this->id_producto = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_PRODUCTO] = true;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_CANTIDAD] = true;
        }
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ESTADO] = true;
        }
    ...
    public function setChangeCount($v)
    {
        ...
        if ($this->change_count !== $v) {
            $this->change_count = $v;
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_CHANGE_COUNT] = true;
        }
    ...
    public function setIdUserModified($v)
    {
        ...
        if ($this->id_user_modified !== $v) {
            ...
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_USER_MODIFIED] = true;
        }
    ...
    public function setIdUserCreated($v)
    {
        ...
        if ($this->id_user_created !== $v) {
            ...
            $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_USER_CREATED] = true;
        }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_DATE_MODIFIED] = true;
            }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdDetallePedido', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_detalle_pedido = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdComanda', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_comanda = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdVaso', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_vaso = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdProducto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_producto = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('Cantidad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cantidad = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('Estado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estado = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('ChangeCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdUserModified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_modified = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('IdUserCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_modified = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : HbfDetallesPedidosTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 11; // 11 = HbfDetallesPedidosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\HbfDetallesPedidos'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aHbfVasos !== null && $this->id_vaso !== $this->aHbfVasos->getIdVaso()) {
            $this->aHbfVasos = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHbfDetallesPedidosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see HbfDetallesPedidos::setDeleted()
     * @see HbfDetallesPedidos::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHbfDetallesPedidosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HbfDetallesPedidosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aHbfVasos !== null) {
                if ($this->aHbfVasos->isModified() || $this->aHbfVasos->isNew()) {
                    $affectedRows += $this->aHbfVasos->save($con);
                }
                $this->setHbfVasos($this->aHbfVasos);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO] = true;
        if (null !== $this->id_detalle_pedido) {
        ...
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO)) {
            $modifiedColumns[':p' . $index++]  = 'id_detalle_pedido';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_COMANDA)) {
            $modifiedColumns[':p' . $index++]  = 'id_comanda';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_VASO)) {
            $modifiedColumns[':p' . $index++]  = 'id_vaso';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_PRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = 'id_producto';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_CANTIDAD)) {
            $modifiedColumns[':p' . $index++]  = 'cantidad';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'estado';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_CHANGE_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'change_count';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_USER_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_modified';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_USER_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_created';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_DATE_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'date_modified';
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }

        $sql = sprintf(
            'INSERT INTO hbf_detalles_pedidos (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_detalle_pedido':
                        $stmt->bindValue($identifier, $this->id_detalle_pedido, PDO::PARAM_INT);
                        break;
                    case 'id_comanda':
    ...
    {
        $pos = HbfDetallesPedidosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdDetallePedido();
                break;
            case 1:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['HbfDetallesPedidos'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['HbfDetallesPedidos'][$this->hashCode()] = true;
        $keys = HbfDetallesPedidosTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdDetallePedido(),
            $keys[1] => $this->getIdComanda(),
            $keys[2] => $this->getIdVaso(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aHbfVasos) {
                ...
                $result[$key] = $this->aHbfVasos->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\HbfDetallesPedidos
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdDetallePedido($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdComanda($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setIdVaso($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdProducto($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO, $this->id_detalle_pedido);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_COMANDA)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_COMANDA, $this->id_comanda);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_VASO)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_VASO, $this->id_vaso);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_PRODUCTO)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_PRODUCTO, $this->id_producto);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_CANTIDAD)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_CANTIDAD, $this->cantidad);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ESTADO)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ESTADO, $this->estado);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_CHANGE_COUNT)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_CHANGE_COUNT, $this->change_count);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_USER_MODIFIED)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_USER_MODIFIED, $this->id_user_modified);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_ID_USER_CREATED)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_ID_USER_CREATED, $this->id_user_created);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(HbfDetallesPedidosTableMap::COL_DATE_CREATED)) {
            $criteria->add(HbfDetallesPedidosTableMap::COL_DATE_CREATED, $this->date_created);
        }
    ...
    {
        $criteria = ChildHbfDetallesPedidosQuery::create();
        $criteria->add(HbfDetallesPedidosTableMap::COL_ID_DETALLE_PEDIDO, $this->id_detalle_pedido);
    ...
    {
        $validPk = null !== $this->getIdDetallePedido();
    ...
    /**
     * Generic method to set the primary key (id_detalle_pedido column).
     *
    ...
    {
        return null === $this->getIdDetallePedido();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \HbfDetallesPedidos (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIdVaso($this->getIdVaso());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdDetallePedido(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \HbfDetallesPedidos Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCiUsuariosRelatedByIdUserCreated(ChildCiUsuarios $v = null)
    {
        ...
        if ($v !== null) {
            $v->addHbfDetallesPedidosRelatedByIdUserCreated($this);
        }
    ...
    public function getCiUsuariosRelatedByIdUserCreated(ConnectionInterface $con = null)
    {
        if ($this->aCiUsuariosRelatedByIdUserCreated === null && ($this->id_user_created != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCiUsuariosRelatedByIdUserCreated->addHbfDetallesPedidossRelatedByIdUserCreated($this);
             */
        }
    ...
    public function setCiUsuariosRelatedByIdUserModified(ChildCiUsuarios $v = null)
    {
        ...
        // If this object has already been added to the ChildCiUsuarios object, it will not be re-added.
        if ($v !== null) {
            $v->addHbfDetallesPedidosRelatedByIdUserModified($this);
        }
    ...
    public function getCiUsuariosRelatedByIdUserModified(ConnectionInterface $con = null)
    {
        if ($this->aCiUsuariosRelatedByIdUserModified === null && ($this->id_user_modified != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCiUsuariosRelatedByIdUserModified->addHbfDetallesPedidossRelatedByIdUserModified($this);
             */
        }
    ...
    public function getHbfProductos(ConnectionInterface $con = null)
    {
        if ($this->aHbfProductos === null && ($this->id_producto != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aHbfProductos->addHbfDetallesPedidoss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildHbfVasos object.
     *
     * @param  ChildHbfVasos $v
     * @return $this|\HbfDetallesPedidos The current object (for fluent API support)
     * @throws PropelException
     */
    public function setHbfVasos(ChildHbfVasos $v = null)
    {
        if ($v === null) {
            $this->setIdVaso(NULL);
        } else {
            $this->setIdVaso($v->getIdVaso());
        }

        $this->aHbfVasos = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildHbfVasos object, it will not be re-added.
        if ($v !== null) {
            $v->addHbfDetallesPedidos($this);
        }
    ...
    /**
     * Get the associated ChildHbfVasos object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildHbfVasos The associated ChildHbfVasos object.
     * @throws PropelException
     */
    public function getHbfVasos(ConnectionInterface $con = null)
    {
        if ($this->aHbfVasos === null && ($this->id_vaso != 0)) {
            $this->aHbfVasos = ChildHbfVasosQuery::create()->findPk($this->id_vaso, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aHbfVasos->addHbfDetallesPedidoss($this);
             */
        }

        return $this->aHbfVasos;
    }
    ...
    public function getHbfComandas(ConnectionInterface $con = null)
    {
        if ($this->aHbfComandas === null && ($this->id_comanda != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aHbfComandas->addHbfDetallesPedidoss($this);
             */
        }
    ...
    {
        if (null !== $this->aCiUsuariosRelatedByIdUserCreated) {
            $this->aCiUsuariosRelatedByIdUserCreated->removeHbfDetallesPedidosRelatedByIdUserCreated($this);
        }
        if (null !== $this->aCiUsuariosRelatedByIdUserModified) {
            $this->aCiUsuariosRelatedByIdUserModified->removeHbfDetallesPedidosRelatedByIdUserModified($this);
        }
        if (null !== $this->aHbfProductos) {
            $this->aHbfProductos->removeHbfDetallesPedidos($this);
        }
        if (null !== $this->aHbfVasos) {
            $this->aHbfVasos->removeHbfDetallesPedidos($this);
        }
        if (null !== $this->aHbfComandas) {
            $this->aHbfComandas->removeHbfDetallesPedidos($this);
        }
        $this->id_detalle_pedido = null;
    ...
    {
        return (string) $this->exportTo(HbfDetallesPedidosTableMap::DEFAULT_STRING_FORMAT);
    }
