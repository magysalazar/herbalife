...
class Migration_Create_hbf_porciones extends CI_Migration
{
    const tableId = 'id_porcion';
    const tableName = 'hbf_porciones';
  ...
  'hbf_porciones_ibfk_1' => 
  array (
    'table' => 'ci_usuarios',
    'idLocal' => 'id_user_created',
    'idForeign' => 'id_usuario',
  ),
  'hbf_porciones_ibfk_2' => 
  array (
    'table' => 'ci_usuarios',
    'idLocal' => 'id_user_modified',
    'idForeign' => 'id_usuario',
  ),
  'hbf_porciones_ibfk_3' => 
  array (
    'table' => 'hbf_productos',
    'idLocal' => 'id_producto',
    'idForeign' => 'id_producto',
  ...
  'views' => true,
    ...
    {
        //$this->dbforge->drop_table('hbf_porciones');
    }
}