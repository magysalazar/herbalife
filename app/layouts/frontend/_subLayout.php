    ...
    <header id="header" class="full-header">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="index.html" class="standard-logo" data-dark-logo="gui/canvas/images/logo-dark.png"><img src="<?=site_url('gui/canvas/images/logo.png')?>" alt="Canvas Logo"></a>
                    <a href="index.html" class="retina-logo" data-dark-logo="gui/canvas/images/logo-dark@2x.png"><img src="<?=site_url('gui/canvas/images/logo@2x.png')?>" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
                            ...
                            <div class="top-cart-items">
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="<?=site_url('gui/canvas/images/shop/small/1.jpg')?>" alt="Blue Round-Neck Tshirt" /></a>
                                    </div>
                                ...
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="<?=site_url('gui/canvas/images/shop/small/6.jpg')?>" alt="Light Blue Denim Dress" /></a>
                                    </div>
                                    <div class="top-cart-item-desc">
                ...
                <div id="shop" class="clearfix">
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/1.jpg')?>" alt="Checked Short Dress"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/1-1.jpg')?>" alt="Checked Short Dress"></a>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/pants/1-1.jpg')?>" alt="Slim Fit Chinos"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/pants/1.jpg')?>" alt="Slim Fit Chinos"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                            ...
                            <div class="fslider" data-arrows="false">
                                <div class="flexslider">
                                    <div class="slider-wrap">
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/shoes/1.jpg')?>" alt="Dark Brown Boots"></a></div>
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/shoes/1-1.jpg')?>" alt="Dark Brown Boots"></a></div>
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/shoes/1-2.jpg')?>" alt="Dark Brown Boots"></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="product-overlay">
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/2.jpg')?>" alt="Light Blue Denim Dress"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/2-2.jpg')?>" alt="Light Blue Denim Dress"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/sunglasses/1.jpg')?>" alt="Unisex Sunglasses"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/sunglasses/1-1.jpg')?>" alt="Unisex Sunglasses"></a>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/tshirts/1.jpg')?>" alt="Blue Round-Neck Tshirt"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/tshirts/1-1.jpg')?>" alt="Blue Round-Neck Tshirt"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/watches/1.jpg')?>" alt="Silver Chrome Watch"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/watches/1-1.jpg')?>" alt="Silver Chrome Watch"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/shoes/2.jpg')?>" alt="Men Grey Casual Shoes"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/shoes/2-1.jpg')?>" alt="Men Grey Casual Shoes"></a>
                            <div class="sale-flash">Sale!</div>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <div class="fslider" data-arrows="false">
                                <div class="flexslider">
                                    <div class="slider-wrap">
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/3.jpg')?>" alt="Pink Printed Dress"></a></div>
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/3-1.jpg')?>" alt="Pink Printed Dress"></a></div>
                                        <div class="slide"><a href="#"><img src="<?=site_url('gui/canvas/images/shop/dress/3-2.jpg')?>" alt="Pink Printed Dress"></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="product-overlay">
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/pants/5.jpg')?>" alt="Green Trousers"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/pants/5-1.jpg')?>" alt="Green Trousers"></a>
                            <div class="sale-flash">Sale!</div>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/sunglasses/2.jpg')?>" alt="Men Aviator Sunglasses"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/sunglasses/2-1.jpg')?>" alt="Men Aviator Sunglasses"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                    ...
                    <div class="product clearfix">
                        <div class="product-image">
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/tshirts/4.jpg')?>" alt="Black Polo Tshirt"></a>
                            <a href="#"><img src="<?=site_url('gui/canvas/images/shop/tshirts/4-1.jpg')?>" alt="Black Polo Tshirt"></a>
                            <div class="product-overlay">
                                <a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a>
                                <a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a>
                            </div>
                ...
                <div class="col_two_third">
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="widget clearfix">
                            ...
                            <img src="<?=site_url('gui/canvas/images/footer-widget-logo.png')?>" alt="" class="footer-logo">

                            <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

                            <div style="background: url('<?=site_url('gui/canvas/images/world-map.png')?>') no-repeat center center; background-size: 100%;">
                                <address>
