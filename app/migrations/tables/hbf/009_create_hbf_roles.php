...
class Migration_Create_hbf_roles extends CI_Migration
{
    public function up()
    {
        $fields = array (
  ...
  array (
    ...
    'idForeign' => 'id_usuario',
        ...
        $this->create_or_alter_table('hbf_roles');
        $settings = array (
  'ctrl' => true,
  'model' => true,
  'views' => true,
);
        $this->set_settings($settings,'hbf_roles');
    }

    public function down()
    {
        //$this->dbforge->drop_table('hbf_roles');
    }
}