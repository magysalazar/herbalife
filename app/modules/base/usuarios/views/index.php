        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="control-label" for="product_name">Usuario</label>
        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5></h5>
                        <?= anchor("base/usuarios/edit", "<i class='fa fa-plus'></i> Agregar Usuario", "class='btn btn-primary btn-xs m-l-sm'"); ?>
                        <?php
                        
                        echo anchor("base/usuarios/edit/draft", "<i class='fa fa-plus'></i> Agregar Draft", "class='btn btn-primary btn-xs m-l-sm'");
                        
                        echo anchor("base/usuarios/edit/tipo_usuario", "<i class='fa fa-plus'></i> Agregar Cliente", "class='btn btn-primary btn-xs m-l-sm'");
                        
                        echo anchor("base/usuarios/edit/ini", "<i class='fa fa-plus'></i> Agregar Ini", "class='btn btn-primary btn-xs m-l-sm'");
