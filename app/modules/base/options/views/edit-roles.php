...
<h3><?= empty($oOption->id_option) ? "Agregar Opciones del Sistema para: Roles" : "Actualizando datos, Option #" . $oOption->id_option ?></h3>

<?php
    //startInsertEachOne
    ?>

<?= form_open_multipart("base/options/edit/roles/".$oOption->id_option,["id" => "optionsEdit"]) ?>
