...
<h3><?= empty($oOption->id_option) ? "Agregar Opciones del Sistema para: Tipo Asociado" : "Actualizando datos, Option #" . $oOption->id_option ?></h3>

<?php
    //startInsertEachOne
    ?>

<?= form_open_multipart("base/options/edit/tipo_asociado/".$oOption->id_option,["id" => "optionsEdit"]) ?>
