...
<h3><?= empty($oOption->id_option) ? "Agregar Opciones del Sistema para: Prepagos" : "Actualizando datos, Option #" . $oOption->id_option ?></h3>

<?php
    //startInsertEachOne
    ?>

<?= form_open_multipart("base/options/edit/prepagos/".$oOption->id_option,["id" => "optionsEdit"]) ?>
...
<?php echo form_error("num_fichas"); ?>
